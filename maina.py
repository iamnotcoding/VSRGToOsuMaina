...
def create_RN(file, key_count, lane_index, start_time): # regular note
    file.write(f'{int(512 / key_count * lane_index - 512 / key_count / 2)},192,{start_time},1,0,0:0:0:0:\n') 
    # I guess this is the right way to calculate. Who cares anyway

def create_LN(file, key_count, lane_index, start_time, end_time) : # long note
    file.write(f'{int(512 / key_count * lane_index - 512 / key_count / 2)},192,{start_time},128,0,{end_time}:0:0:0:0:\n') 